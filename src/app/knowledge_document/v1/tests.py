...
class KnowledgeDocumentListAPITest(APITestCase):
    MODEL = KnowledgeDocument
    PATH = "/v1/knowledge_document/"
...
class KnowledgeDocumentCreateAPITest(APITestCase):
    MODEL = KnowledgeDocument
    PATH = "/v1/knowledge_document/"
...
class KnowledgeDocumentRetrieveAPITest(APITestCase):
    MODEL = KnowledgeDocument
    PATH = "/v1/knowledge_document/{id}/"
...
class KnowledgeDocumentUpdateAPITest(APITestCase):
    MODEL = KnowledgeDocument
    PATH = "/v1/knowledge_document/{id}/"
...
class KnowledgeDocumentDestroyAPITest(APITestCase):
    MODEL = KnowledgeDocument
    PATH = "/v1/knowledge_document/{id}/"
